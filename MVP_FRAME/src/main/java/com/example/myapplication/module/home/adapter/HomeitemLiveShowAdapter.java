...
public class HomeitemLiveShowAdapter extends BaseAdapter {
    private List<HomeDataBean.DataBean.PandaliveBean.ListBean>mlist;
    private LayoutInflater inflater;
    private Context context;

    public HomeitemLiveShowAdapter(List<HomeDataBean.DataBean.PandaliveBean.ListBean> mlist, Context context) {
        this.mlist = mlist;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HomeDataBean.DataBean.PandaliveBean.ListBean listBean = mlist.get(position);
